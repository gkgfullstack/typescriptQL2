...
const PreviewTable: React.FC<PreviewProps> = ({resultid, downloadurl}) => {
  ...
  return (
    <>
    <Button type="link" onClick={showModal} style={{ padding: '0px', minWidth: 'auto', lineHeight: '10px', marginTop: '-5px', height: 'auto' }}>
                  <FontAwesomeIcon icon={['fal', 'eye']} color={'gray'} style={{fontSize:'16px'}} />
                </Button>
                <Modal
                  title={[
                    <div className="modalHeadershow">                     
                      <div style={{ float: 'right' }}><a href={url} className="item" rel="noopener noreferrer" 
