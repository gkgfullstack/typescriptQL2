...
const ResultsRowDelete: React.FC<ResultsRowDeleteProps> = ({ selectedRowKeyVal, runId }) => {
  ...
  height: '20px', fontSize: '22px', backgroundColor: 'transparent'
  }}>
    <ButtonGroup className={styles.btngroups}>
     ...
     <Popconfirm
          ...
          >
                <Button id="archive" type="default" style={{minWidth:'auto'}}>
              <FontAwesomeIcon icon={['fal', 'trash-alt']} style={{color:'#6f6f6f', margin:'0 10px 0 0'}}/> Delete  
          </Button>
          </Popconfirm>
    </ButtonGroup>
    </span>
