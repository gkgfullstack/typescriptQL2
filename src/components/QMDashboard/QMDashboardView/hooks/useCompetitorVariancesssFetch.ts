...
const initialState: FetchState<VarianceFilter[]> = {
  loading: false,
  error: false,
  data: null,
};

const useCompetitorVariancesssFetch = (): [FetchState<VarianceFilter[]>] => {
  ...
  return [state as FetchState<VarianceFilter[]>];
};

export default useCompetitorVariancesssFetch;
