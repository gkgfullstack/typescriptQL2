...
import styles from './MultiSelectionListSelected.module.less';
...
const MultiSelectionListSelected: React.FC<MultiSelectionListProps> = ({
  onSearch,
  onChange,
  data = [],
  defaultValue,
...
export default MultiSelectionListSelected;
