 ...
 values,
  ...
  return (
    <Popover
      ...
      >
        <Button type="default" style={{ marginRight: '10px', width: '100%', textAlign: 'left' }}>Filter <FontAwesomeIcon icon={['far', 'chevron-down']} className={styles.chevronDown} size="sm" style={{marginTop:'5px', float:'right'}}/></Button>
      </Popover>
  );
};
