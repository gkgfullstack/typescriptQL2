import { getColumns } from './ConfigurationCompetitorSitesTable.service';
...
it('should be correct titles of getColumns method', () => {
    ...
    expect(columns[6].title).toBe('Outlier Enabled');
});
...
it('should be correct keys of getColumns method', () => {
    ...
    expect(columns[6].key).toBe('outlierdetectioninclusionflag');
});