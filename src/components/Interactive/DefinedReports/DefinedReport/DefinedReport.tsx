...
import styles from './DefinedReport.module.less';
...
export type DefinedReportProps = {
  url: string;
};
const DefinedReport: React.FC<DefinedReportProps> = ({ url }: DefinedReportProps) => {
