...
type CreateHotelPropertyLocationProps = {
  onAdd: (values: any) => void;
  isAddDisabled: boolean;
};

const CreateHotelPropertyLocation: React.FC<CreateHotelPropertyLocationProps> = ({ onAdd, isAddDisabled }) => {
  ...
  const onAddLocation = () => {
    onAdd([{ name, address, location, state: province, zip, country }]);
    setName('');
    setAddress('');
    setLocation('');
    setProvince('');
...
export default CreateHotelPropertyLocation;
