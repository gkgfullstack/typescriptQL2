...
import styles from './CreateVacationPropertyName.module.less';
...
const CreateVacationPropertyName: React.FC<CreateVacationPropertyNameProps> = ({
  label,
  onAdd,
  flexed,
  editCompset,
          ...
          >
            <Collapse defaultActiveKey={['0']} expandIconPosition="right">
              <Panel
                header={
                  <h6>
                    List property IDs <span className={styles.create_vacation_subtext}>(one per line)</span>
                  </h6>
                }
                key={'1'}
              >
...
export default CreateVacationPropertyName;
