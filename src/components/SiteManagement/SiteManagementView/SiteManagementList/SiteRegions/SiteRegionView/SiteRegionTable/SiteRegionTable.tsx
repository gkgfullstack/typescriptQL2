...
import styles from './SiteRegionTable.module.less';
import { Button, Table } from 'antd';
import ConfirmationCentered from 'src/components/common/ConfirmationCentered';
import { Sorting } from 'src/types/Sorting';
import { getColumns } from './services/SiteRegionTable.service';
...
const SiteRegionTable: React.FC<ConfigurationSiteRegionTableProps> = ({
  siteId,
  schema,
  onEditRegion,
  requestParams,
  ...
  const [loading, totalRecords, siteList] = useGetConfigureRegionList(undefined, siteId, requestParams);
  ...
  useDeleteRegionFromSite(undefined, deletedRegionList, setDeletedRegionList, onUpdate, schema);
  ...
  const handlerPageChange = (page: number): void => {
    console.log(page, 'number handle');
    setPage(page);
  };
...
export default SiteRegionTable;
